...
<body>
    ...
    <div class="sidebar" id="sidebar">
        ...
        <div class="sidebar-nav">
            ...
            <a href="${pageContext.request.contextPath}/AdminBookServlet" class="active">Manage Book</a>
    ...
    <div class="main-content" id="mainContent">
        ...
        <form id="addBookForm" action="${pageContext.request.contextPath}/addBookServlet" method="post" enctype="multipart/form-data">
            <div class="add-book-container">
                ...
                <div class="book-form-section">
                    ...
                    <div class="button-group">
                        ...
                        <button type="button" class="btn-cancel" onclick="window.location.href='${pageContext.request.contextPath}/AdminBookServlet'">Cancel</button>
                    </div>
                </div>
            </div>
        </form>
        ...
        function closeMessage() {
            ...
            if (messageBox && overlay) {
                ...
                if (messageBox.classList.contains('success')) {
                    window.location.href = '${pageContext.request.contextPath}/AdminBookServlet';
                }
            }
        }
    </script>
